...
const uint8_t appSKey[16] = { 0x--, 0x5A, 0x43, 0x97, 0x6C, 0xFD, 0x07, 0x9E, 0xF2, 0x9C, 0xC4, 0xE2, 0xB2, 0x3E, 0x76, 0xF0 };
const uint8_t nwkSKey[16] = { 0x--, 0x34, 0x91, 0xE5, 0x10, 0xF4, 0x02, 0x41, 0x01, 0x49, 0x6A, 0x52, 0xAD, 0x76, 0x06, 0x2D };



// OTAA
uint8_t DevEUI[8] = { 0x00, 0x04, 0xA3, 0x0B, 0x00, 0x1B, 0xEF, 0x52 };
uint8_t AppEUI[8] = { 0x--, 0xB3, 0xD5, 0x7E, 0xF0, 0x00, 0x61, 0xF7 };
uint8_t AppKey[16] = { 0x--, 0x64, 0xFC, 0xDE, 0x4F, 0xEB, 0x9F, 0xF5, 0x35, 0xE8, 0xCB, 0x7B, 0x89, 0xC5, 0x9D, 0x2A };
